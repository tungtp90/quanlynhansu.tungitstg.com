      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <div class="box-tools pull-left ">              
            <button type="submit" class="btn btn-primary btn-sm" name="save">Thực hiện import</button>
            </div>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php 
                  // show data
                     $showData = "SELECT id, ma_nv, hinh_anh, ten_nv, gioi_tinh, ngay_tao, ngay_sinh, tam_tru, so_cmnd, so_dien_thoai, email, trang_thai FROM nhanvien ORDER BY id DESC";
