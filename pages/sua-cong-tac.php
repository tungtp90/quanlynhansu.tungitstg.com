...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  {
    $id = $_GET['id'];
    $act = "SELECT ma_cong_tac, nv.id as idNhanVien, ma_nv, ten_nv, ngay_bat_dau, ngay_ket_thuc, dia_diem, muc_dich, ghi_chu_ct FROM cong_tac ct, nhanvien nv WHERE ct.nhanvien_id = nv.id AND ct.id = $id";
  ...
  if(isset($_POST['save']))
  {
    ...
    if(!$error)
    {
      ...
      if($result)
      {
        ...
        echo '<script>setTimeout("window.location=\'sua-cong-tac.php?p=collaborate&a=add-collaborate&id='.$id.'\'",10000);</script>';
      }
    }
  }
...
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Sửa hợp đồng thử việc</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
                    <li class="breadcrumb-item active">Sửa hợp đồng thử việc</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="col-xs-12">
          <div class="card card-info">
            <div class="card-header with-border">
              <h3 class="card-title">Sửa hợp đồng thử việc</h3>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <textarea id="editor1" rows="10" cols="220" name="mucDich"><?php echo $rowAct['muc_dich']; ?>
                      </textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Ghi chú: </label>
                      <textarea id="editor1" rows="1" cols="220" name="ghiChu"><?php echo $rowAct['ghi_chu_ct']; ?>
                      </textarea>
                    </div>
                    <div class="form-group">
