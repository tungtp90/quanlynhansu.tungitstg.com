...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  $nv = "SELECT ctn.id as id, ma_nv, hinh_anh, ten_nv, gioi_tinh, ngay_sinh, ten_chuc_vu, ten_phong_ban, ctn.ngay_tao as ngay_tao, trang_thai_lv FROM chi_tiet_nhom ctn, nhanvien nv, chuc_vu cv, phong_ban pb WHERE ctn.nhan_vien_id = nv.id AND nv.chuc_vu_id = cv.id AND nv.phong_ban_id = pb.id AND ma_nhom = '$id'";
