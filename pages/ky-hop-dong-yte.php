              ...
              <form action="" method="POST" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="loaiHD">
                        <option value="chon">--- Chọn loại hợp đồng ---</option>
                    ...
                    <div class="form-group">
                      ...
                      <textarea id="editor" rows="1" class="form-control" name="noiDungHD"></textarea>
                    </div>
                    <div class="form-group">
                  ...
                  <div class="col-md-6">                    
                      ...
                      <div class="form-group">
                      <label>Mẫu hợp đồng <span style="color: red;">*</span>: </label>
                      <select class="form-control" name="loaiHD">
                        <option value="chon">--- Chọn mẫu hợp đồng ---</option>
                        <option value="1">Mẫu hợp đồng dành cho cán bộ y tế</option>
                        <option value="2">Hợp đồng dành cho cán bộ khác</option>                        
                      </select>
                      <small style="color: red;"><?php if(isset($error['loaiHD'])){ echo "Vui lòng chọn loại hợp đồng"; } ?></small>
                    </div>
                      <!-- /.form-group -->                    
